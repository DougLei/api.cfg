...
- 功能描述: 重置用户登陆密码，改为初始密码
- api地址: /common/user/pwd/reset
- 请求类型: PUT
- 请求头:
```
{
...
- 功能描述: 重置用户的账户信息，即将用户的工号、手机号、邮箱三个字段的值，重新更新到账户的帐号、手机号、邮箱三个字段的值，同时重置账户的登陆密码为初始密码
...
- 功能描述: 重置账户登陆密码，改为初始密码
- api地址: /common/account/pwd/reset
- 请求类型: PUT
- 请求头:
```
{
