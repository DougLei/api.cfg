...
- 功能描述: 物理删除一条用户信息，同时会物理删除关联的账户信息，以及所有关联关系，目前包括所属的部门、所属的职务、所属的角色、所属的用户组 【支持批量操作】
- api地址: /common/user/physical_delete
- 请求类型: DELETE
- 请求头:
```
{
...
- 功能描述: 物理删除一条账户信息 【支持批量操作】
- api地址: /common/account/physical_delete
- 请求类型: DELETE
- 请求头:
```
{
...
- 功能描述: 添加一条账户卡信息 【支持批量操作】
- api地址: /common/account/card/add
- 请求类型: POST
- 请求头:
```
{
...
- 功能描述: 修改一条账户卡信息
- api地址: /common/account/card/update
- 请求类型: PUT
- 请求头:
```
{
...
```
{
  "Id":"",                                             --主键
  "cardNo":"",                                         --卡号
  "status":""                                          --卡状态:1.启用，2.禁用
}
```

#### 3. 删除账户卡

- 功能描述: 逻辑删除一条账户卡信息 【支持批量操作】
- api地址: /common/account/card/delete
- 请求类型: DELETE
- 请求头:
```
{
...
- 功能描述: 关联账户卡和用户的关系 【支持批量操作】
- api地址: /common/card/user/relation/add
- 请求类型: POST
- 请求头:
```
{
...
- 功能描述: 取消关联账户卡和用户的关系 【支持批量操作】
- api地址: /common/card/user/relation/cancel
- 请求类型: POST
- 请求头:
```
{
