package com.king.tooth.workflow.entity.wf.ru;
...
@Table
public class WfRuTaskTransactor extends WfBasicEntity implements IEntity, IEntityPropAnalysis{
	...
	public CfgTable toCreateTable() {
		...
		table.setName("流程运行时，任务处理人表");
		table.setRemark("流程运行时，任务处理人表");
	...
	public String toDropTable() {
		return "WF_RU_TASK_TRANSACTOR";
	}

	@JSONField(serialize = false)
	public String getEntityName() {
		return "WfRuTaskTransactor";
	}
