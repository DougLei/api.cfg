...
public class CfgDatabaseCfgTabledataLinks implements Serializable, ITable {
	
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "CFG_DATABASE_TABLEDATA_LINKS");
	...
	public String toDropTable() {
		return "CFG_DATABASE_TABLEDATA_LINKS";
	}
}
