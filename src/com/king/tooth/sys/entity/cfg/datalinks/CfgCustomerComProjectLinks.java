...
/**
 * [配置系统]客户和配置的项目的关联关系资源对象
 * @author DougLei
 */
@SuppressWarnings("serial")
public class CfgCustomerComProjectLinks implements Serializable, ITable {
	
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "CFG_CUSTOMER_COM_PROJ_LINKS");
		table.setName("[配置系统]客户和配置的项目的关联关系资源对象");
		table.setComments("[配置系统]客户和配置的项目的关联关系资源对象");
	...
	public String toDropTable() {
		return "CFG_CUSTOMER_COM_PROJ_LINKS";
	}
}
