...
/**
 * [配置系统]客户和系统账户的关联关系资源对象
 * @author DougLei
 */
@SuppressWarnings("serial")
public class CfgCustomerComSysAccountLinks implements Serializable, ITable {
	
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "CFG_CUST_COM_ACCOUNT_LINKS");
		table.setName("[配置系统]客户和系统账户的关联关系资源对象");
		table.setComments("[配置系统]客户和系统账户的关联关系资源对象");
	...
	public String toDropTable() {
		return "CFG_CUST_COM_ACCOUNT_LINKS";
	}
}
