...
/**
 * [配置系统]数据库和sql脚本的关联关系资源对象
 * @author DougLei
 */
@SuppressWarnings("serial")
public class CfgDatabaseComSqlScriptLinks implements Serializable, ITable {
	
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "CFG_DATABASE_SQLSCRIPT_LINKS");
	...
	public String toDropTable() {
		return "CFG_DATABASE_SQLSCRIPT_LINKS";
	}
}
