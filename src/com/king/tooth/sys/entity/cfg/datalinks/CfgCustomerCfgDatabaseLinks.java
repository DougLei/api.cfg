...
/**
 * [配置系统]客户和数据库的关联关系资源对象
 * @author DougLei
 */
@SuppressWarnings("serial")
public class CfgCustomerCfgDatabaseLinks implements Serializable, ITable {
	
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "CFG_CUSTOMER_DB_LINKS");
		table.setName("[配置系统]客户和数据库的关联关系资源对象");
		table.setComments("[配置系统]客户和数据库的关联关系资源对象");
