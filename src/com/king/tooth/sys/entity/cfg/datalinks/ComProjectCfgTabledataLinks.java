...
/**
 * [配置系统]项目和数据表的关联关系资源对象
 * @author DougLei
 */
@SuppressWarnings("serial")
public class ComProjectCfgTabledataLinks implements Serializable, ITable {
	
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "CFG_PROJ_CFG_TABLEDATA_LINKS");
		table.setName("[配置系统]项目和数据表的关联关系资源对象");
		table.setComments("[配置系统]项目和数据表的关联关系资源对象");
	...
	public String toDropTable() {
		return "CFG_PROJ_CFG_TABLEDATA_LINKS";
	}
}
