...
public class CfgColumnCodeRuleDetail extends BasicEntity implements ITable, IEntity, IEntityPropAnalysis{
	...
	public List<ComColumndata> getColumnList() {
		...
		ComColumndata columnCodeRuleIdColumn = new ComColumndata("column_code_rule_id", DataTypeConstants.STRING, 32);
		...
		ComColumndata linkNextSymbolColumn = new ComColumndata("link_next_symbol", DataTypeConstants.STRING, 5);
		...
		ComColumndata ruleTypeColumn = new ComColumndata("rule_type", DataTypeConstants.INTEGER, 1);
		...
		ComColumndata defValueColumn = new ComColumndata("defValue", DataTypeConstants.STRING, 10);
		defValueColumn.setName("默认固定值");
		defValueColumn.setComments("默认值为空字符串");
		defValueColumn.setDefaultValue("");
		columns.add(defValueColumn);
		
		ComColumndata dateFormateColumn = new ComColumndata("date_formate", DataTypeConstants.STRING, 20);
		...
		ComColumndata seqReinitTimeColumn = new ComColumndata("seq_reinit_time", DataTypeConstants.INTEGER, 1);
		...
		ComColumndata seqStartValColumn = new ComColumndata("seq_start_val", DataTypeConstants.INTEGER, 8);
		...
		ComColumndata seqCurrentValColumn = new ComColumndata("seq_current_val", DataTypeConstants.INTEGER, 8);
		seqCurrentValColumn.setName("序列的当前值");
		seqCurrentValColumn.setComments("序列的当前值");
		columns.add(seqCurrentValColumn);
		
		ComColumndata seqSkipValColumn = new ComColumndata("seq_skip_val", DataTypeConstants.INTEGER, 4);
		...
		ComColumndata randomLengthColumn = new ComColumndata("random_length", DataTypeConstants.INTEGER, 15);
		...
		ComColumndata randomSeedValColumn = new ComColumndata("random_seed_val", DataTypeConstants.INTEGER, 15);
		...
		ComColumndata columnValFromColumn = new ComColumndata("column_val_from", DataTypeConstants.INTEGER, 1);
		...
		ComColumndata queryColumnIdColumn = new ComColumndata("query_column_id", DataTypeConstants.STRING, 32);
		queryColumnIdColumn.setName("查询列的id");
		queryColumnIdColumn.setComments("查询列的id");
		columns.add(queryColumnIdColumn);
		
		ComColumndata queryColumnCondValColumn = new ComColumndata("query_column_cond_val", DataTypeConstants.STRING, 60);
		queryColumnCondValColumn.setName("查询列的条件值");
		queryColumnCondValColumn.setComments("查询列的条件值");
		columns.add(queryColumnCondValColumn);
		
		ComColumndata typeColumnValFromColumn = new ComColumndata("type_column_val_from", DataTypeConstants.INTEGER, 1);
		...
		ComColumndata typeRefTableIdColumn = new ComColumndata("type_ref_table_id", DataTypeConstants.STRING, 32);
		typeRefTableIdColumn.setName("类型引用表的id");
		typeRefTableIdColumn.setComments("类型引用表的id");
		columns.add(typeRefTableIdColumn);
		
		ComColumndata typeRefColumnIdColumn = new ComColumndata("type_ref_column_id", DataTypeConstants.STRING, 32);
		typeRefColumnIdColumn.setName("类型引用列的id");
		typeRefColumnIdColumn.setComments("类型引用列的id");
		columns.add(typeRefColumnIdColumn);
		
		ComColumndata typeQueryColumnIdColumn = new ComColumndata("type_query_column_id", DataTypeConstants.STRING, 32);
		typeQueryColumnIdColumn.setName("类型查询列的id");
		typeQueryColumnIdColumn.setComments("类型查询列的id");
		columns.add(typeQueryColumnIdColumn);
		
		ComColumndata typeQueryColumnCondValColumn = new ComColumndata("type_query_column_cond_val", DataTypeConstants.STRING, 60);
		...
		ComColumndata typeMapJsonColumn = new ComColumndata("type_map_json", DataTypeConstants.STRING, 300);
