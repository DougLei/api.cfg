...
public class IETableResourceMetadataInfo extends IEResourceMetadataInfo{
	...
	public IETableResourceMetadataInfo(String columnName, String dataType, Integer length, Integer precision, Integer isUnique, Integer isNullabled, Integer isIgnoreValid, String id, CfgPropConfExtend ieConfExtend, String propName, String descName) {
