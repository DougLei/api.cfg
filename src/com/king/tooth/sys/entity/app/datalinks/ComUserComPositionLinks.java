...
public class ComUserComPositionLinks implements Serializable, ITable {
	
	public ComTabledata toCreateTable() {
		ComTabledata table = new ComTabledata("COM_USER_POSITION_LINKS", 0);
		table.setResourceName("ComUserComPositionLinks");
		table.setName("人员和职务的关联关系资源对象");
		table.setComments("人员和职务的关联关系资源对象");
	...
	public String toDropTable() {
		return "COM_USER_POSITION_LINKS";
	}
}
