...
public class ComUserRunDeptLinks implements Serializable, ITable {
	
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "COM_USER_RUN_DEPT_LINKS");
		table.setName("[运行系统]人员和部门的关联关系资源对象表");
		table.setComments("[运行系统]人员和部门的关联关系资源对象表");
	...
	public String toDropTable() {
		return "COM_USER_RUN_DEPT_LINKS";
	}
}
