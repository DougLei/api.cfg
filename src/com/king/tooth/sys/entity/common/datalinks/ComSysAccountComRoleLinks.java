...
public class ComSysAccountComRoleLinks implements Serializable, ITable {
	...
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "COM_ACCOUNT_COM_ROLE_LINKS");
		table.setName("[通用的]系统账户和角色的关联关系资源对象表");
		table.setComments("[通用的]系统账户和角色的关联关系资源对象表");
	...
	public String toDropTable() {
		return "COM_ACCOUNT_COM_ROLE_LINKS";
	}
}
