...
public class ComProjectComSqlScriptLinks implements Serializable, ITable {
	...
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "COM_PROJ_SQLSCRIPT_LINKS");
		table.setName("[通用的]项目和sql脚本的关联关系资源对象");
		table.setComments("[通用的]项目和sql脚本的关联关系资源对象");
	...
	public String toDropTable() {
		return "COM_PROJ_SQLSCRIPT_LINKS";
	}
}
