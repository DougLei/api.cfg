...
public class ComDatabaseComProjectLinks implements Serializable, ITable {
	
	public ComTabledata toCreateTable(String dbType) {
		ComTabledata table = new ComTabledata(dbType, "COM_DATABASE_PROJECT_LINKS", 0);
		table.setResourceName("ComDatabaseComProjectLinks");
		table.setVersion(1);
		table.setName("数据库和项目的关系表");
		table.setComments("数据库和项目的关系表");
	...
	public String toDropTable() {
		return "COM_DATABASE_PROJECT_LINKS";
	}
}
