...
public class ComRoleComPermissionLinks implements Serializable, ITable {
	
	public CfgTabledata toCreateTable(String dbType) {
		CfgTabledata table = new CfgTabledata(dbType, "COM_ROLE_PERMISSION_LINKS");
		table.setName("[通用的]角色和权限关联关系资源对象表");
		table.setComments("[通用的]角色和权限关联关系资源对象表");
	...
	public String toDropTable() {
		return "COM_ROLE_PERMISSION_LINKS";
	}
}
