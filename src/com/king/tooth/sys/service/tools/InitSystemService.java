...
public class InitSystemService extends AService{
	...
	private List<CfgTable> getAllTables(){
		...
		tables.add(new CfgPropCodeRule().toCreateTable());
		tables.add(new CfgPropCodeRuleDetail().toCreateTable());
		...
		tables.add(new CfgBusiResModel().toCreateTable());
		tables.add(new CfgBusiResModelRelations().toCreateTable());
		return tables;
	}
