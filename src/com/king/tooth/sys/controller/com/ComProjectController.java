...
public class ComProjectController extends AbstractPublishController{
	...
	@ResponseBody
	public String add(@RequestBody ComProject project){
	...
	@ResponseBody
	public String update(@RequestBody ComProject project){
		String result = project.analysisResourceProp();
		if(result == null){
	 ...
	 * @return
	 */
	@RequestMapping(value="/cancelRelation", method = RequestMethod.DELETE, produces = "application/json;charset=utf-8")
	@ResponseBody
	public String cancelRelation(HttpServletRequest request){
		String projectId = request.getParameter("projectId");
		if(StrUtils.isEmpty(projectId)){
