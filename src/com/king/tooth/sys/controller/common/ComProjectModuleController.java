...
public class ComProjectModuleController extends AbstractResourceController{
	...
	@org.springframework.web.bind.annotation.ResponseBody
	public ResponseBody search(@RequestBody ComProjectModule projectModule){
		return null;
	}
	...
	@org.springframework.web.bind.annotation.ResponseBody
	public ResponseBody delete(@RequestBody ComProjectModule projectModule){
		return null;
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="/editcontent", method = RequestMethod.PUT)
	@org.springframework.web.bind.annotation.ResponseBody
	public ResponseBody editContent(@RequestBody ComProjectModule projectModule){
		return null;
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="/operManager", method = RequestMethod.POST)
	@org.springframework.web.bind.annotation.ResponseBody
	public ResponseBody operManager(@RequestBody ComProjectModule projectModule){
		return null;
	}
}
