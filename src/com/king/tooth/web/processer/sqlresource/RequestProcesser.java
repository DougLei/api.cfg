...
public abstract class RequestProcesser extends RequestProcesserCommon implements IRequestProcesser{
	...
	public final ResponseBody doRequestProcess(){
		...
		builtinSqlResourceBMProcesser = new BuiltinSqlResourceBMProcesser(requestBody.getReqSqlScriptResource(), requestBody.getRequestUrlParams(), requestBody.getFormData(), sqlParameterValues);
