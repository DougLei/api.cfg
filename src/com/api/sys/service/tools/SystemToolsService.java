...
import com.api.sys.entity.tools.resource.ResourceInfo;
...
public class SystemToolsService {
	...
	private void setSqlResourceStruct(String sqlResourceId, ResourceInfo resourceInfo) {
		List<Object[]> sqlParams = HibernateUtil.executeListQueryByHqlArr(null, null, "select name, dataType from CfgSqlParameter where sqlScriptId=? and valueFrom=0", sqlResourceId);
