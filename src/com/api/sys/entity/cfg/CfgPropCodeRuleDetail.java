...
import com.api.sys.entity.cfg.prop.code.rule.CurrentStageCodeProcesser;
...
public class CfgPropCodeRuleDetail extends BasicEntity implements IEntity, IEntityPropAnalysis{
	...
	/**
	 * 属性组序列属性名
	 * <p>多个用,分割，优先级高于prop_group_seq_prop_ids，ruleType为11的使用到该字段</p>
	 */
	...
	public List<CfgColumn> getColumnList() {
		...
		propGroupSeqPropNamesColumn.setComments("多个用,分割，优先级高于prop_group_seq_prop_ids，ruleType为11的使用到该字段");
