package com.api.web.builtin.method.common.util.querycondfunc;
...
import com.api.web.builtin.method.common.util.querycondfunc.entity.HqlQueryCondFuncEntity;
import com.api.web.builtin.method.common.util.querycondfunc.entity.IQueryCondFuncEntity;
import com.api.web.builtin.method.common.util.querycondfunc.entity.SqlQueryCondFuncEntity;

/**
 * 内置的查询条件函数工具类
 * 例如:eq、btn等
 * @see com.api.web.builtin.method.tableresource.querycondfunc.impl下的类
 * @author DougLei
 */
